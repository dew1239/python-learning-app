...
""",
        "quiz": [
            ...
            {
            "question": """พิจารณาโค้ด Python ต่อไปนี้:\n\n```python\nx = 5\ny = 10\nprint('ผลรวม: %s + %s = %s' % (x, y, x + y))\n```\n\nข้อใดถูกต้องที่สุด?""",
            "choices": [
            "โค้ดทำงานได้ถูกต้อง และแสดงผลลัพธ์เป็น: ผลรวม: 5 + 10 = 15",
            "เกิด SyntaxError เนื่องจากมีการใช้เครื่องหมาย % ในการจัดรูปแบบสตริง (String Formatting)",
            "เกิด TypeError เนื่องจากตัวแปร x, y, และ x + y เป็นจำนวนเต็ม (Integer) แต่ใช้ตัวกำหนดรูปแบบ %s (String)",
            "เกิด ValueError เนื่องจากจำนวนของตัวกำหนดรูปแบบ (%s) ไม่ตรงกับจำนวนของตัวแปรที่ส่งมาหลังเครื่องหมาย %",
            ],
            "answer": "A. โค้ดทำงานได้ถูกต้อง และแสดงผลลัพธ์เป็น: ผลรวม: 5 + 10 = 15",
            },
        ],
    },
...
""",
        "quiz": [
            ...
            "choices": [
            "โค้ดทำงานได้ถูกต้อง และแสดงผลลัพธ์เป็น: 25",
            "โค้ดทำงานได้ถูกต้อง และแสดงผลลัพธ์เป็น: 26",
            "เกิด TypeError เนื่องจากชนิดข้อมูลไม่เข้ากัน",
            "เกิด ValueError เนื่องจากสตริงที่พยายามแปลงเป็นจำนวนเต็มมีรูปแบบทศนิยม (Float)",
            ],
            "answer": "เกิด ValueError เนื่องจากสตริงที่พยายามแปลงเป็นจำนวนเต็มมีรูปแบบทศนิยม (Float)",
            },
        ],
    },
...
""",
        "quiz": [
            ...
            {
            "question": """การแปลงชนิดข้อมูล (Casting)\nพิจารณาโค้ด Python ต่อไปนี้:\n\n```python\nmy_list = [10, \"apple\", 5.5]\nresult = str(my_list)\nprint(result[1])\n```\n\nข้อใดคือผลลัพธ์ที่ถูกต้องที่สุดของโค้ดชุดนี้?""",
            "choices": [
            "10",
            "[",
            "1",
