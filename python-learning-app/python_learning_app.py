...
""",
        "quiz": [
            ...
            "choices": [
            "A. โค้ดทำงานได้ถูกต้อง และแสดงผลลัพธ์เป็น: ผลรวม: 5 + 10 = 15",
            "B. เกิด SyntaxError เนื่องจากมีการใช้เครื่องหมาย % ในการจัดรูปแบบสตริง (String Formatting)",
            "C. เกิด TypeError เนื่องจากตัวแปร x, y, และ x + y เป็นจำนวนเต็ม (Integer) แต่ใช้ตัวกำหนดรูปแบบ %s (String)",
            "D. เกิด ValueError เนื่องจากจำนวนของตัวกำหนดรูปแบบ (%s) ไม่ตรงกับจำนวนของตัวแปรที่ส่งมาหลังเครื่องหมาย %",
            ],
